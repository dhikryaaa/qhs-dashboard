@php
    $kategoris = [
        ['id' => '01', 'kode_kategori' => 'K001', 'nama_kategori' => 'Safety Equipment', 'status' => 'Y'],
        ['id' => '02', 'kode_kategori' => 'K002', 'nama_kategori' => 'Quality Tools', 'status' => 'N'],
        ['id' => '03', 'kode_kategori' => 'K003', 'nama_kategori' => 'Environmental', 'status' => 'Y'],
        ['id' => '04', 'kode_kategori' => 'K004', 'nama_kategori' => 'Health Services', 'status' => 'Y'],
        ['id' => '05', 'kode_kategori' => 'K005', 'nama_kategori' => 'Emergency Response', 'status' => 'N'],
    ];
@endphp
    ...
    <table class="role-table">
        ...
        <tbody id="roleTableBody">
            ...
            <tr class="role-row">
                ...
                <td>
                    <div class="toggle-switch {{ $kategori['status'] === 'Y' ? 'active' : '' }}" 
                         onclick="toggleStatus(this, '{{ $kategori['id'] }}')"
                ...
                <td>
                    <div class="action-icons">
                        <span class="action-icon" title="Edit" onclick="openEditModal('{{ $kategori['id'] }}', '{{ $kategori['kode_kategori'] }}', '{{ $kategori['nama_kategori'] }}')">
                        ...
                        <span class="action-icon" title="Delete" onclick="openDeleteModal('{{ $kategori['id'] }}', '{{ $kategori['nama_kategori'] }}')">
            ...
            <form>
                <div class="form-row">
                    <div class="form-group-half">
                        ...
                        <input type="text" class="form-input-half" placeholder="Masukkan kode kategori">
                    </div>
                    <div class="form-group-half">
                        <label class="form-label">Nama Kategori</label>
                        <input type="text" class="form-input-half" placeholder="Masukkan nama kategori">
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-body">
            <form>
                ...
                <div class="form-row">
                    <div class="form-group-half">
                        <label class="form-label">Kode Kategori</label>
                        <input type="text" id="editKodeKategori" class="form-input-half" placeholder="Masukkan kode kategori">
                    </div>
                    <div class="form-group-half">
                        <label class="form-label">Nama Kategori</label>
                        <input type="text" id="editNamaKategori" class="form-input-half" placeholder="Masukkan nama kategori">
                    </div>
                </div>
            </form>
        </div>
...
<script>
    ...
    function openEditModal(id, kodeKategori, namaKategori) {
    ...
    function update() {
        ...
        const kodeKategori = document.getElementById('editKodeKategori').value;
        const namaKategori = document.getElementById('editNamaKategori').value;
        
        console.log('Update Kategori:', { id, kodeKategori, namaKategori });
    ...
    function toggleStatus(element, id) {
        ...
        console.log(`Kategori ID: ${id}, New Status: ${newStatus}`);
    }
    ...
    function filterTable() {
        ...
        allRows.forEach((row, index) => {
            ...
            const namaKategori = row.cells[2].textContent.toLowerCase();
            
            if (kodeKategori.includes(searchInput) || namaKategori.includes(searchInput)) {
    ...
    function confirmDelete() {
        if (itemToDelete) {
            console.log(`Deleting Kategori ID: ${itemToDelete}, Name: ${itemNameToDelete}`);
            alert(`Kategori "${itemNameToDelete}" will be deleted (backend integration needed)`);
            closeDeleteModal();
        }
    }
