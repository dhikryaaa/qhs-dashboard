...
@section('page-title')
<h1 class="page-title-header">Master / Role</h1>
@endsection
        ...
        <div class="modal-body">
            <form id="roleForm">
                <div class="form-group">
                    ...
                    <input type="text" id="kodeRoleInput" class="form-input" placeholder="Masukkan kode role">
                </div>
                <div class="form-group">
                    <label class="form-label">Nama Role</label>
                    <input type="text" id="namaRoleInput" class="form-input" placeholder="Masukkan nama role">
                </div>
            </form>
        </div>
