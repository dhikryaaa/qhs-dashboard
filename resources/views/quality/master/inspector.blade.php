...
@section('page-title')
<h1 class="page-title-header">Master / Inspector</h1>
@endsection

@section('content')
<style>
    /* ========== MASTER INSPECTOR PAGE STYLES ========== */
...
<!-- Modal Lookup Employee Popup (468px x 359px) -->
<div id="lookupPopupModal" class="modal-overlay">
    <div class="lookup-popup-window">
        <div class="lookup-popup-header">
            <input type="text" id="lookupSearchInput" class="lookup-search-input" placeholder="Cari No Induk atau Nama">
                ...
                <div class="form-row">
                    <div class="form-group-half">
                        ...
                        <div class="input-with-icon">
                            <input type="text" id="inspectorNoInduk" class="form-input-half" placeholder="No Induk" readonly onclick="openLookupPopup()">
                            <span class="input-icon" onclick="openLookupPopup()">
                    ...
                    <div class="form-group-half">
                        ...
                        <input type="text" id="inspectorNama" class="form-input-half readonly-gray" placeholder="Nama" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-label">Kualifikasi</label>
                    <input type="text" class="form-input" placeholder="Masukkan kualifikasi">
                </div>
                <div class="form-group">
                    <label class="form-label">Sertifikat</label>
                    <input type="text" class="form-input" placeholder="Masukkan sertifikat">
                </div>
            </form>
        </div>
...
<script>
    ...
    function selectEmployee(noInduk, nama) {
        document.getElementById('inspectorNoInduk').value = noInduk;
        document.getElementById('inspectorNama').value = nama;
